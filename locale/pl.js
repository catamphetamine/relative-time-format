...
var quantify = function(e){var i=String(e).split("."),n=i[0],r=!i[1],s=n.slice(-1),t=n.slice(-2);return 1==e&&r?"one":r&&2<=s&&s<=4&&(t<12||14<t)?"few":r&&1!=n&&(0==s||1==s)||r&&5<=s&&s<=9||r&&12<=t&&t<=14?"many":"other"}
